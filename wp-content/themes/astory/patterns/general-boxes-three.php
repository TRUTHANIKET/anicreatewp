 ...
 * Slug: astory/general-boxes-three
 * Categories: astory-general
 * Viewport Width: 1280
 */
...
<!-- wp:heading {"level":3} -->
<h3 id="sample-heading-1"><?php echo esc_html__( 'Sample Heading', 'astory' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:button {"style":{"className":"is-style-fill-base"} -->
<div class="wp-block-button is-style-fill-base"><a class="wp-block-button__link "><?php echo esc_html__( 'Learn More', 'astory' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-column has-main-background-color has-background" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px">
<!-- wp:heading {"level":3} -->
<h3 id="sample-heading-2"><?php echo esc_html__( 'Sample Heading', 'astory' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing vestibulum. Fringilla nec accumsan eget, facilisis mi justo, luctus pellentesque.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column has-main-background-color has-background" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px">
<!-- wp:heading {"level":3} -->
<h3 id="sample-heading-3"><?php echo esc_html__( 'Sample Heading', 'astory' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing vestibulum. Fringilla nec accumsan eget, facilisis mi justo, luctus pellentesque.</p>
<!-- /wp:paragraph -->
