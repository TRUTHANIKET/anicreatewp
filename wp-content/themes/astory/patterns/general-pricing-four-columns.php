 ...
 * Slug: astory/general-pricing-four-columns
 * Categories: astory-price
 * Viewport Width: 1280
 */
...
<h2 class="has-text-align-center has-x-large-font-size" id="pricing-table"><?php echo esc_html__( 'Pricing Table', 'astory' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'Create a four-column table', 'astory' ); ?>.</p>
<!-- /wp:paragraph -->
...
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Personal', 'astory' ); ?> - $99</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Feature Item', 'astory' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:button {"style":{}} -->
<div class="wp-block-button"><a class="wp-block-button__link "><?php echo esc_html__( 'Sign Up Now', 'astory' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-group has-base-color has-main-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Professional', 'astory' ); ?> - $299</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"main"} -->
...
<div class="wp-block-group has-base-color has-main-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Enterprise', 'astory' ); ?> - $499</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"main"} -->
...
<div class="wp-block-group has-base-color has-main-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Ultimate', 'astory' ); ?> - $995</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"main"} -->
