 ...
 * Slug: astory/general-cta-button
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link" style="border-radius:0px;padding-top:15px;padding-right:25px;padding-bottom:15px;padding-left:25px"><?php echo esc_html__( 'Let’s Get Started', 'astory' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
